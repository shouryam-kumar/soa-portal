          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                {/* Edit Proposal button for owner, only if editable */}
                {isCreator && proposal.status !== 'under_review' && proposal.status !== 'approved' && proposal.status !== 'rejected' && (
                  <Link href={`/proposals/${proposal.id}/edit`}>
                    <button className="w-full mt-2 bg-blue-700 hover:bg-blue-600 text-white rounded-lg px-4 py-2 text-sm flex items-center justify-center">
                      Edit Proposal
                    </button>
                  </Link>
                )}
